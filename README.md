...
* [WhisperSubs](https://github.com/GeiserX/whisper-subs) - Jellyfin plugin for local AI-powered subtitle generation using Whisper, with all processing on your server.
